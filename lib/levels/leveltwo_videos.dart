...
import 'package:mini_coder/videos/leveltwo.dart';
...
class LevelTwoVideos extends StatelessWidget {
  const LevelTwoVideos({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Level Two Videos'),
          centerTitle: true,
