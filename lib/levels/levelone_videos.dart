...
import 'package:mini_coder/videos/levelone.dart';
...
class LevelOneVideos extends StatelessWidget {
  const LevelOneVideos ({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Level One Videos'),
          centerTitle: true,
